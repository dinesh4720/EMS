        ...
        homeworkList.length === 0 ? (
          ...
          homeworkList.map(hw => (
            <Card key={hw.id}>
              ...
              {hw.voiceNote && (
                <View style={styles.filesRow}>
                  <Feather name="mic" size={14} color={COLORS.gray} />
                  <Text style={styles.filesText}>Voice note attached</Text>
                </View>
              )}
            </Card>
          ))
...
function AnnounceTab({ classId, students, getAnnouncements, addAnnouncement }) {
  ...
  const handleAdd = () => {
    if (!title.trim()) return Alert.alert('Error', 'Title is required');
    addAnnouncement(classId, { title, description, students: selectedStudents, voiceNote });
    setTitle(''); 
    setDescription(''); 
...
const styles = StyleSheet.create({
  ...
  emptyText: { color: COLORS.gray, fontSize: 15, fontFamily: 'Inter_400Regular' },
  ...
  pendingActionText: { fontSize: 13, color: COLORS.warning, fontFamily: 'Inter_500Medium', marginLeft: SPACING.s },
  ...
  summaryValue: { fontSize: 28, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  summaryLabel: { fontSize: 12, color: COLORS.gray, marginTop: 4, fontFamily: 'Inter_400Regular' },
  ...
  infoBannerText: { fontSize: 13, color: COLORS.blue, marginLeft: SPACING.s, fontFamily: 'Inter_400Regular' },
  ...
  gridName: { marginTop: SPACING.s, fontSize: 12, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  gridRoll: { fontSize: 10, color: COLORS.gray, fontFamily: 'Inter_400Regular' },
  ...
  avatarTextSmall: { fontSize: 16, fontFamily: 'Inter_500Medium', color: COLORS.white },
  ...
  studentAvatarText: { fontSize: 20, fontFamily: 'Inter_500Medium', color: COLORS.white },
  studentInfo: { flex: 1, marginLeft: SPACING.m },
  studentName: { fontSize: 16, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  studentMeta: { fontSize: 13, color: COLORS.gray, marginTop: 2, fontFamily: 'Inter_400Regular' },
  ...
  studentStatValue: { fontSize: 18, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  studentStatLabel: { fontSize: 11, color: COLORS.gray, marginTop: 2, fontFamily: 'Inter_400Regular' },
  remarksSection: { marginBottom: SPACING.m },
  remarksTitle: { fontSize: 12, fontFamily: 'Inter_500Medium', color: COLORS.gray, marginBottom: 4 },
  remarkText: { fontSize: 13, color: COLORS.dark, marginTop: 2, fontFamily: 'Inter_400Regular' },
  ...
  studentActionText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: COLORS.primary, marginLeft: 6 },

  // Overview Card
  overviewCard: { marginBottom: SPACING.m, backgroundColor: COLORS.primaryLight },
  overviewTitle: { fontSize: 14, fontFamily: 'Inter_500Medium', color: COLORS.primary, marginBottom: SPACING.m },
  overviewStats: { flexDirection: 'row' },
  overviewStat: { flex: 1, alignItems: 'center' },
  overviewStatValue: { fontSize: 22, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  overviewStatLabel: { fontSize: 11, color: COLORS.gray, marginTop: 2, fontFamily: 'Inter_400Regular' },
  ...
  toggleText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: COLORS.gray, marginLeft: 6 },
  toggleTextActive: { color: COLORS.white },

  // Form
  input: { borderWidth: 1, borderColor: COLORS.lightGray, borderRadius: 10, padding: SPACING.m, fontSize: 15, marginBottom: SPACING.m, backgroundColor: COLORS.white, fontFamily: 'Inter_400Regular' },
  ...
  attachText: { fontSize: 13, color: COLORS.gray, marginLeft: 6, fontFamily: 'Inter_400Regular' },

  // Card Content
  cardHeaderRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' },
  cardTitle: { fontSize: 16, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  cardMeta: { fontSize: 13, color: COLORS.gray, marginTop: 2, fontFamily: 'Inter_400Regular' },
  cardBody: { fontSize: 14, color: COLORS.gray, marginTop: SPACING.s, lineHeight: 20, fontFamily: 'Inter_400Regular' },
  cardDate: { fontSize: 12, color: COLORS.primary, marginTop: SPACING.s, fontFamily: 'Inter_500Medium' },
  ...
  filesText: { fontSize: 12, color: COLORS.gray, marginLeft: 4, fontFamily: 'Inter_400Regular' },

  // Lesson Selector
  lessonSelector: { marginBottom: SPACING.m },
  lessonSelectorTitle: { fontSize: 13, fontFamily: 'Inter_500Medium', color: COLORS.gray, marginBottom: SPACING.s },
  ...
  lessonChipText: { fontSize: 12, color: COLORS.gray, fontFamily: 'Inter_400Regular' },
  lessonChipTextActive: { color: COLORS.white },

  // Enter Marks
  enterMarksBtn: { flexDirection: 'row', alignItems: 'center' },
  enterMarksText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: COLORS.primary },

  // Recipient Selector
  recipientSelector: { marginBottom: SPACING.m },
  recipientTitle: { fontSize: 13, fontFamily: 'Inter_500Medium', color: COLORS.gray, marginBottom: SPACING.s },
  ...
  recipientText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: COLORS.gray },
  recipientTextActive: { color: COLORS.white },
  recipientInfo: { fontSize: 12, color: COLORS.gray, marginTop: SPACING.s, fontStyle: 'italic', fontFamily: 'Inter_400Regular' },
  ...
  modalTitle: { fontSize: 20, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  modalSubtitle: { fontSize: 14, color: COLORS.gray, marginBottom: SPACING.m, fontFamily: 'Inter_400Regular' },
  modalInput: { borderWidth: 1, borderColor: COLORS.lightGray, borderRadius: 12, padding: SPACING.m, fontSize: 15, marginBottom: SPACING.m, textAlignVertical: 'top', fontFamily: 'Inter_400Regular' },
  ...
  fullscreenTitle: { fontSize: 18, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  backBtn: { padding: SPACING.s },
  marksSubtitle: { fontSize: 14, color: COLORS.gray, marginBottom: SPACING.m, fontFamily: 'Inter_400Regular' },
  ...
  marksName: { fontSize: 15, fontFamily: 'Inter_500Medium', color: COLORS.dark },
  marksRoll: { fontSize: 12, color: COLORS.gray, fontFamily: 'Inter_400Regular' },
  marksInput: { borderWidth: 1, borderColor: COLORS.lightGray, borderRadius: 8, padding: SPACING.s, width: 70, textAlign: 'center', fontSize: 16, fontFamily: 'Inter_500Medium' },
});
