  ...
  return (
    <div className="bg-white dark:bg-zinc-950 border border-gray-100 dark:border-zinc-800 rounded-lg p-4">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <p className="text-sm font-semibold text-gray-800 dark:text-zinc-100">{t('components.quickStats')}</p>
          <p className="text-xs text-gray-500 dark:text-zinc-400">{t('components.weeklyPerformanceMetrics')}</p>
        </div>
      </div>
      ...
      <div className="p-3 rounded-lg border border-gray-100 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900 mb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-gray-700 dark:text-zinc-300">{t('components.monthlyFeeCollection')}</span>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-center">
          ...
          <p className="text-[10px] font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wide mt-1">{t('components.avgDept')}</p>
        </div>
        <div className="p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-center">
          ...
          <p className="text-[10px] font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wide mt-1">{t('components.newAdmins')}</p>
        </div>
        <div className="p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-center">
          <div className="flex items-center justify-center gap-1">
          ...
          <p className="text-[10px] font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wide mt-1">{t('components.onLeave')}</p>
        </div>
      </div>
    </div>
  );
