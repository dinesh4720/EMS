    ...
    <div className="bg-white dark:bg-zinc-950 rounded-lg border border-gray-200 dark:border-zinc-800 overflow-hidden">
      ...
      <div className="p-5 border-b border-gray-200 dark:border-zinc-800">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-medium text-gray-900 dark:text-zinc-100 text-sm">{t('components.recentActivity')}</h3>
        </div>
      ...
      <div className="divide-y divide-gray-200 dark:divide-zinc-800">
        {filteredActivities.length > 0 ? (
          ...
          <div className="px-5 py-10 text-center">
            ...
            <p className="text-sm font-medium text-gray-700 dark:text-zinc-300">{t('components.noRecentActivityYet')}</p>
            <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">{t('components.paymentsAndAnnouncementsWillAppearHereOnceTheyAreRecorded')}</p>
          </div>
        )}
      </div>
