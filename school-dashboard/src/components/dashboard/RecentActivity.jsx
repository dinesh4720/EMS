...
export default function RecentActivity({
  payments, announcements, communications }) {
  ...
  return (
    <Card className="shadow-sm border border-default-200 bg-content1/50 backdrop-blur-sm rounded-2xl">
      ...
      <CardBody className="p-4">
        <Tabs aria-label={t('aria.inputs.activityTabs')} color="secondary" variant="solid" radius="sm" classNames={{ tabList: "bg-default-100/50" }} size="sm">
          <Tab
            key="payments"
            title={
