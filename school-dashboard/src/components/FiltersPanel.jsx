                        ...
                        {presets.length > 0 && (
                            ...
                            >
                                <div className="flex items-center gap-2 px-1">
                                    ...
                                    <span className="text-xs font-semibold text-default-500 uppercase tracking-wider">Quick Presets</span>
                                </div>
                        ...
                        {activeFiltersList.length > 0 && (
                            ...
                            >
                                <div className="flex items-center justify-between px-1">
                                    <span className="text-xs font-semibold text-default-500 uppercase tracking-wider">Active Filters</span>
                                    <button
