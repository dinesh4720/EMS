    ...
    <Card className="border border-danger-200">
      <CardHeader className="bg-danger-50 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-danger-700">Timetable Data Cleanup</h3>
            <p className="text-xs text-danger-500">Clear all timetable-related data</p>
          </div>
        </div>
        <Button
          size="sm"
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-warning-50 border border-warning-200 rounded-lg p-3 flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-warning-700">Warning: This action cannot be undone</p>
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-gray-700">Select what to clear:</p>
