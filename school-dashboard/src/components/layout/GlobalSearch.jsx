          ...
          <div className="max-h-[400px] overflow-y-auto p-2">
            {studentsLoading && allResults.length === 0 ? (
              <div className="py-8 text-center text-default-400">
                ...
                <p className="text-sm">{t('globalSearch.searchingStudents')}</p>
              </div>
            ) : allResults.length === 0 ? (
              <div className="py-8 text-center text-default-400">
              ...
              <>
                {renderSection(t('globalSearch.categories.pages'), searchResults.navigation, (currentIndex = 0, currentIndex))}
                {renderSection(t('globalSearch.categories.staff'), searchResults.staff, (currentIndex += searchResults.navigation.length, currentIndex))}
                {renderSection(t('globalSearch.categories.students'), searchResults.students, (currentIndex += searchResults.staff.length, currentIndex))}
                {renderSection(t('globalSearch.categories.classes'), searchResults.classes, (currentIndex += searchResults.students.length, currentIndex))}
              </>
            )}
          </div>
