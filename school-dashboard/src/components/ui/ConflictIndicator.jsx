    ...
    return (
      <div className="space-y-3">
        ...
        <div className="bg-default-100 rounded-lg p-3">
          <p className="text-xs text-default-500 mb-1">{t('components.teacher1')}</p>
        ...
        <div className="bg-default-100 rounded-lg p-3">
          <p className="text-xs text-default-500 mb-1">{t('components.timeSlot')}</p>
          <p className="text-sm font-semibold text-default-900">
        ...
        {type === 'double_booking' && conflictList && conflictList.length > 0 && (
          <div className="bg-danger-50 border border-danger-200 rounded-lg p-3">
            <p className="text-xs text-danger-600 font-semibold mb-2">{t('components.conflictingClasses')}</p>
        ...
        {type === 'unqualified' && (
          <div className="bg-warning-50 border border-warning-200 rounded-lg p-3">
            <p className="text-xs text-warning-600 font-semibold mb-1">{t('components.qualificationIssue')}</p>
        ...
        <div className="bg-default-50 border border-default-200 rounded-lg p-3">
          <p className="text-xs text-default-500 mb-1">{t('components.details')}</p>
      ...
      >
        <ModalContent>
          <ModalHeader className="flex items-center gap-2 border-b border-default-200">
            ...
            <span>{t('components.conflictDetailsResolution')}</span>
          </ModalHeader>
              ...
              <>
                ...
                {selectedConflict.allConflicts && selectedConflict.allConflicts.length > 1 && (
                  <div className="mt-4 space-y-3">
                    <h5 className="text-sm font-semibold text-default-700">{t('components.allConflicts')}</h5>
                ...
                <div className="mt-6 space-y-3">
                  <h5 className="text-sm font-semibold text-default-700">{t('components.resolutionOptions')}</h5>
                  <div className="space-y-2">
