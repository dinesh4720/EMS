...
const DOT_TONE = {
  neutral: "bg-fg-faint ring-bg",
  primary: "bg-accent ring-bg",
  success: "bg-ok ring-bg",
  warning: "bg-warn ring-bg",
  danger: "bg-danger-token ring-bg",
  info: "bg-info-token ring-bg",
};
