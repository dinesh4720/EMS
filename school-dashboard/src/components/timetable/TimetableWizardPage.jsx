      ...
      <ModalContent className="h-screen rounded-none m-0 shadow-none border-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 z-10 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold font-outfit text-gray-900 leading-tight">{t('components.masterTimetableWizard')}</h1>
        ...
        <div className="flex h-[calc(100vh-81px)] w-full relative">
          ...
          <div className="w-80 bg-white border-r border-gray-200 shrink-0 flex flex-col pt-6 pb-6 px-4 gap-2 z-10 overflow-y-auto">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-2">{t('components.wizardSteps')}</p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 line-clamp-2">{t('components.ensureAllClassesHaveTheirSubjectsCorrectlyAssigned')}</p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 line-clamp-2">{t('components.assignClassTeachersAndVerifySubjectInstructors')}</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 line-clamp-2">{t('components.automaticallyBuildClashFreeTimetablesForEveryone')}</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 line-clamp-2">{t('components.reviewManuallyTweakAndExportGeneratedTimetables')}</p>
              </div>
            </button>
          </div>
              ...
              <div className="max-w-4xl mx-auto p-8 space-y-6">
                <div className="bg-white rounded-2xl shadow-sm border border-orange-200 overflow-hidden">
                  <div className="bg-orange-50 border-b border-orange-100 p-6 flex items-start gap-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-orange-800 mb-1">{t('components.missingSubjectAssignments')}</h2>
                      ...
                      return (
                        <div key={classIdStr || index} className="flex flex-col md:flex-row md:items-center gap-4 p-5 bg-gray-50 border border-gray-200 rounded-xl hover:border-orange-300 transition-colors">
                          <div className="flex-shrink-0 w-48">
                            ...
                            <p className="text-sm text-gray-500">{t('components.unassigned')}</p>
                          </div>
            ...
            {activeTab === "generate" && (
              <div className="max-w-4xl mx-auto p-8 flex flex-col items-center justify-center min-h-[70vh]">
                <div className="bg-white p-12 rounded-3xl shadow-sm border border-gray-200 text-center max-w-2xl">
                  ...
                  <h2 className="text-3xl font-bold font-outfit text-gray-900 mb-4">{t('components.autoGenerateTimetables')}</h2>
              ...
              <div className="max-w-7xl mx-auto p-8 space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col items-center justify-center text-center">
                    ...
                    <span className="text-sm text-gray-500 font-medium">{t('components.totalClasses')}</span>
                  </div>
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col items-center justify-center text-center">
                    <span className="text-3xl font-bold text-success-600 mb-1">{timetables.length}</span>
                    <span className="text-sm text-gray-500 font-medium">{t('components.timetablesCreated')}</span>
                  </div>
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col items-center justify-center text-center">
                    <span className="text-3xl font-bold text-orange-600 mb-1">{classes.length - timetables.length}</span>
                    <span className="text-sm text-gray-500 font-medium">{t('components.missingTimetables')}</span>
                  </div>
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col items-center justify-center text-center">
                    <span className="text-3xl font-bold disabled text-red-600 mb-1">{classes.filter(c => !c.subjects || c.subjects.length === 0).length}</span>
                    <span className="text-sm text-gray-500 font-medium">{t('components.missingSubjects')}</span>
                  </div>
                </div>
                        ...
                        <div className="p-6 flex-1">
                          ...
                          <div className="space-y-3 mb-6 bg-gray-50 rounded-xl p-4">
                            <div className="flex items-center justify-between text-sm">
                              <span className="text-gray-500">{t('components.totalSubjects')}</span>
                              <span className="font-semibold text-gray-900">{cls.subjects?.length || 0}</span>
                            </div>
                            {timetable && (
                              <div className="flex items-center justify-between text-sm">
                                <span className="text-gray-500">{t('components.periodsPerWeek')}</span>
