    ...
    <div className="bg-white dark:bg-zinc-950 rounded-lg border border-gray-200 dark:border-zinc-800 overflow-hidden sticky top-6">
      <div className="p-5 border-b border-gray-200 dark:border-zinc-800">
        <div className="flex items-center justify-between">
          <h3 className="font-medium text-gray-900 dark:text-zinc-100 text-sm">Alerts</h3>
          {criticalCount > 0 && (
      ...
      {visibleAlerts.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">No live issues need attention right now.</p>
        </div>
      )}
