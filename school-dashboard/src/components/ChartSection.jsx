      ...
      <div className="bg-white dark:bg-zinc-950 rounded-lg border border-gray-200 dark:border-zinc-800 overflow-hidden">
        <div className="p-5 border-b border-gray-200 dark:border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-gray-900 dark:text-zinc-100 text-sm">Attendance Snapshot</h3>
        ...
        <div className="p-5 space-y-4">
          {loading && !hasAttendanceData ? (
            <p className="text-sm text-gray-500 dark:text-zinc-500">Loading attendance data...</p>
          ) : hasAttendanceData ? (
            ...
            <div className="py-8 text-center">
              <p className="text-sm font-medium text-gray-700 dark:text-zinc-300">No attendance recorded yet</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-zinc-500">This section updates once staff or class attendance is marked.</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-950 rounded-lg border border-gray-200 dark:border-zinc-800 overflow-hidden">
        <div className="p-5 border-b border-gray-200 dark:border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-gray-900 dark:text-zinc-100 text-sm">Fee Collection</h3>
              <p className="text-xs text-gray-500 dark:text-zinc-500">Actual receipts over the last 6 months</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-5">
          {loading && !hasFeeData ? (
            <p className="text-sm text-gray-500 dark:text-zinc-500">Loading payment data...</p>
          ) : hasFeeData ? (
            <>
            ...
            <div className="py-8 text-center">
              <p className="text-sm font-medium text-gray-700 dark:text-zinc-300">No fee payments recorded yet</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-zinc-500">Monthly collection trends will appear once receipts are posted.</p>
            </div>
          ) : (
            <div className="py-8 text-center">
              <p className="text-sm font-medium text-gray-700 dark:text-zinc-300">Payment data unavailable</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-zinc-500">The fee collection chart will return once the payments API responds.</p>
            </div>
          )}
        </div>
      </div>
