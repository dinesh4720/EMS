...
export default function Signup() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="w-full lg:w-[45%] flex flex-col items-center justify-center bg-white px-4 py-6 lg:py-0 h-full">
        <div className="w-full max-w-sm">
          <div className="text-center mb-4">
            ...
            <h1 className="text-lg font-bold text-gray-800">Accept your school invite</h1>
          ...
          {inviteLoading ? (
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 text-center">
              <p className="text-sm font-medium text-gray-700">Validating invite link...</p>
            </div>
          ) : accessBlocked ? (
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-5">
              ...
              <p className="text-sm text-amber-900">{inviteError}</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col" autoComplete="off">
              <div className="mb-3 rounded-xl border border-teal-100 bg-teal-50 px-3 py-2">
                <p className="text-xs font-medium text-teal-800">Invite verified</p>
