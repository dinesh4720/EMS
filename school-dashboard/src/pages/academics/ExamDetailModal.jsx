        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              ...
              <p className="font-medium text-gray-900">{exam.maxMarks || exam.totalMarks || 100}</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              <div className="flex items-center gap-2 text-gray-500 mb-1">
                <Award size={14} />
              ...
              <p className="font-medium text-gray-900">{exam.passingMarks || 35}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
              ...
              <p className="text-2xl font-semibold text-blue-700">{results.length}</p>
            </div>
            <div className="bg-green-50 rounded-lg p-4 border border-green-100">
              <p className="text-xs text-green-600">Passed</p>
              <p className="text-2xl font-semibold text-green-700">{passedCount}</p>
            </div>
