  ...
  return (
    <div className="space-y-5 animate-fade-in text-left">
      <div className="space-y-3">
        ...
        <p className="text-xs text-fg-muted -mt-1">{t('staff.form.bankAccountHint')}</p>
      ...
      <div className="space-y-3 pt-5 border-t border-divider">
        ...
        <div className="flex justify-between items-center px-2 pt-2">
          <span className="text-sm font-medium text-fg-muted">{t('staff.form.totalMonthlySalary')}</span>
          <span className="text-lg font-bold text-fg">{fmt(totalSalary)}</span>
        </div>
      </div>
    </div>
  );
