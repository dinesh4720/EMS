...
const MODULES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: "Exam Schedule", route: "/academics/schedule", checks: { design: "pending", a11y: "pending", responsive: "pending", tests: "pending" } },
  ...
  },
  {
    ...
    pages: [
      ...
      { name: "Transactions", route: "/inventory/transactions", checks: { design: "pending", a11y: "pending", responsive: "pending", tests: "pending" } },
    ],
  },
  {
    name: "Hostel",
