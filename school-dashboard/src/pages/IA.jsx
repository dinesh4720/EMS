...
const MODULES = [
  ...
  },
  {
    ...
    name: "Front Desk",
    pages: [
      { name: "FrontDeskPage / Dashboard", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "AdmissionsList", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "AdmissionTracker", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "AppointmentsList", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "CallLogsList", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "FeedbacksList", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "VisitorLog", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
      { name: "GatePassLog", checks: { design: "unchecked", a11y: "unchecked", responsive: "unchecked", tests: "unchecked" } },
    ],
  },
  {
    id: "homework",
