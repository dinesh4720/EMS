...
const MODULES = [
  ...
  },
  {
    name: "Fees",
    dir: "fees/",
    pages: ["FeesDashboard", "FeeTemplates", "FeeAssignments", "FeeCollection", "FeeReports", "Refunds"],
    checks: { design: true, a11y: false, responsive: false, tests: false },
    note: "Design system fixes applied 2026-05-18",
  },
  {
    name: "Front Desk",
    dir: "front-desk/",
  ...
  },
  {
    name: "Hostel",
    dir: "hostel/",
    pages: ["HostelList", "RoomsList", "AllocationsList", "HostelDashboard"],
    checks: { design: "in-progress", a11y: false, responsive: false, tests: false },
    note: "Audit in progress — 2026-05-23",
  },
  {
    name: "Intake Forms",
    dir: "intake-forms/",
