...
const MODULES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: "Fee Structure", route: "/fees/structure", checks: { design: "wip", a11y: "todo", responsive: "todo", tests: "todo" } },
      ...
      { name: "Refunds", route: "/fees/refunds", checks: { design: "wip", a11y: "todo", responsive: "todo", tests: "todo" } },
    ],
  },
  {
    id: "calendar",
