        ...
        <ModalContent>
          ...
          <ModalBody>
            <div className="text-center py-8">
              <p className="text-default-500">No gate pass data available</p>
            </div>
          </ModalBody>
          <ModalFooter>
          ...
          <div ref={printRef} className="print-content p-6 border-2 border-dashed border-gray-300 bg-white">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center border-b pb-2">
                <span className="text-gray-600 font-medium">Gate Pass ID:</span>
              ...
              <div className="border-t pt-3">
                <span className="text-gray-600 text-sm font-medium">Leaving With:</span>
              ...
              <div className="grid grid-cols-2 gap-8 mt-4 pt-2">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600">Security Signature</p>
                </div>
                <div className="text-center">
                  <div className="border-b border-gray-400 mb-1"></div>
