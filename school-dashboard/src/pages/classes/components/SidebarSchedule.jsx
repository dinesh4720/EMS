  ...
  return (
    <div className="bg-surface rounded-lg border border-divider p-5">
      ...
      {periods.length > 0 ? (
        <div className="space-y-2">
          {periods.map((p) => (
            <div key={p.isCurrent ? 'current-period' : 'upcoming-period'} className={`flex items-center gap-3 p-2.5 rounded-lg transition-colors ${p.isCurrent ? 'bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800' : 'bg-surface-2'}`}>
